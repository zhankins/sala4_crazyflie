...
class WallFollowingMultiranger(Node):
    def __init__(self):
        ...
        self.srv = self.create_service(
            Trigger, robot_prefix + "/stop_wall_following", self.stop_wall_following_cb
        )
        ...
        self.get_logger().info(
            f"Wall following set for crazyflie "
            + robot_prefix
    ...
    def timer_callback(self):
        ...
        if side_range > 0.1:
            velocity_x, velocity_y, yaw_rate, state_wf = (
                self.wall_following.wall_follower(
